...
public class JsonReader {
    ...
    private int lastPos, startPos, pos;
    ...
    // Get the given key.
    // This is not very efficient if the entries are not ordered in the correct way:
    // the whole JSON object might need to be scanned twice.
    ...
    public JsonReader get(String key) {
        for (int i = 0; i < 2; i++) {
            ...
            // start from the beginning, but at most once
            pos = startPos;
            nextToken();
        }
        return null;
