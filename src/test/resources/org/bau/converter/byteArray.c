...
int32_t readI32Le_2(i8_array* d, int32_t pos) {
    int64_t _r0 = ( d->data[idx_2(pos, _arrayLen(d))] | (shiftLeft_2(d->data[idx_2(pos + 1, _arrayLen(d))], 8)) ) | (shiftLeft_2(d->data[idx_2(pos + 2, _arrayLen(d))], 16)) | (shiftLeft_2(d->data[idx_2(pos + 3, _arrayLen(d))], 24));
    return _r0;
}
int64_t shiftLeft_2(int64_t a, int64_t b) {
    return a << b;
