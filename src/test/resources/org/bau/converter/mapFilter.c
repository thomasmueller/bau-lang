...
void _main() {
    ...
    if (1) {
        ...
        if (1) {
            ...
            int64_t i = 0;
            while (i < this->size) {
                int64_t it = List_int_get_2(this, i);
                if (( imod_2(it, 2) ) == 0) {
                    List_int_add_2(result, it);
                }
                i = i + 1;
            }
            _incUseStack(result);
    ...
    if (1) {
        ...
        if (1) {
            ...
            while (i < _arrayLen(this)) {
                ...
                if (( imod_2(it, 2) ) == 0) {
                    temp->data[idx_2(j, _arrayLen(temp))] = it;
                    j = j + 1;
                }
                i = i + 1;
            }
        ...
        while (i < _arrayLen(this)) {
            int64_t it = this->data[idx_2(i, _arrayLen(this))];
            result->data[idx_2(i, _arrayLen(result))] = it * it;
            i = i + 1;
        }
        _incUseStack(result);
