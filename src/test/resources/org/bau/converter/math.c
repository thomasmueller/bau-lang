...
int main(int _argc, char *_argv[]) {
    ...
    string_1014 = str_const(" = ", 3);
    string_1015 = str_const("  % ", 4);
    string_1016 = str_const(" >> ", 4);
    string_1017 = str_const(" << ", 4);
    string_1018 = str_const("signum ", 7);
    string_1019 = str_const("abs    ", 7);
    string_1020 = str_const("floor  ", 7);
    string_1021 = str_const("ceil   ", 7);
    string_1022 = str_const("round  ", 7);
    string_1023 = str_const("exp    ", 7);
    string_1024 = str_const("log    ", 7);
    string_1025 = str_const("log10  ", 7);
    string_1026 = str_const("sqrt   ", 7);
    string_1027 = str_const("sin    ", 7);
    string_1028 = str_const("cos    ", 7);
    string_1029 = str_const("tan    ", 7);
    string_1030 = str_const("atan   ", 7);
    string_1031 = str_const("asin   ", 7);
    string_1032 = str_const("acos   ", 7);
    string_1033 = str_const("isNotANumber   ", 15);
    string_1034 = str_const("isNegativeZero ", 15);
    string_1035 = str_const("convertDoubleToLongBits ", 24);
    string_1036 = str_const("convertLongBitsToDouble ", 24);
    string_1037 = str_const("pow ", 4);
    string_1038 = str_const("min ", 4);
    string_1039 = str_const("max ", 4);
    _main();
    return 0;
}
void _main() {
