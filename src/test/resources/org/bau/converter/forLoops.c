...
char **__argv;
/* functions */
pair_float newPair_float_2(double value, int64_t index);
pair_int newPair_int_2(int64_t value, int64_t index);
pair_float pair_float_0();
pair_int pair_int_0();
void i8_array_free(i8_array* x);
void int_array_free(int_array* x);
void float_array_free(float_array* x);
void pair_int_free(pair_int* x);
void pair_int_copy(pair_int* x);
void pair_float_free(pair_float* x);
void pair_float_copy(pair_float* x);
...
void pair_int_free_0(pair_int* x) {
}
void pair_int_free(pair_int* x) {
    _registerAndMaybeDrain(x, (void(*)(void*))pair_int_free_0);
}
void pair_int_copy(pair_int* x) {
}
void pair_float_free_0(pair_float* x) {
}
void pair_float_free(pair_float* x) {
    _registerAndMaybeDrain(x, (void(*)(void*))pair_float_free_0);
}
void pair_float_copy(pair_float* x) {
}
...
pair_float newPair_float_2(double value, int64_t index) {
    pair_float result = pair_float_0();
    result.value = value;
    result.i = index;
    return result;
}
pair_int newPair_int_2(int64_t value, int64_t index) {
    pair_int result = pair_int_0();
    result.value = value;
    result.i = index;
    return result;
}
...
int main(int _argc, char *_argv[]) {
    ...
    __argc = _argc;
    __argv = _argv;
    string_1009 = str_const("element ", 8);
    string_1010 = str_const("index-value-pairs #", 19);
