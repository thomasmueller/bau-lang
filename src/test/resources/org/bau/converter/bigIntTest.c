...
i32_array* i32_array_new(uint64_t len) {
    if (len < 0 || len >= (1L << 31)) arrayOutOfBounds(len, 1L << 31);
...
int64_t org_bau_Int_intToStr_4(int64_t n, i8_array* buff, int64_t start, int64_t size);
...
void org_bau_BigInt_str_free_0(org_bau_BigInt_str* x) {
...
i8_array* string_1074;
i8_array* string_1076;
i8_array* string_1078;
i8_array* string_1080;
i8_array* string_1082;
i8_array* string_1084;
i8_array* string_1086;
i8_array* string_1088;
i8_array* string_1090;
i8_array* string_1092;
i8_array* string_1094;
i8_array* string_1096;
int64_t randomSeed;
int64_t MIN_INT;
int64_t MAX_INT;
int64_t MIN_I32;
...
i8_array* org_bau_BigInt_copyOfRange_i8_array_i8_3(i8_array* a, int64_t from, int64_t to) {
    _incUseStack(a);
    int64_t len = to - from;
    i8_array* _t18 = i8_array_new(len);
    _incUseStack(_t18);
    i8_array* x = _t18;
    int64_t i = 0;
    while (1 == 1) {
        int64_t _t19 = ( i + from ) < to;
        if (_t19) {
            int64_t _t20 = i < _arrayLen(a);
            _t19 = _t20;
        }
        if (!(_t19)) {
            break;
...
org_bau_BigInt_str org_bau_BigInt_str_0() {
    org_bau_BigInt_str _t13 = org_bau_BigInt_str_new();
    _t13.data = i8_array_new(0);
    return _t13;
}
org_bau_BigInt_bigInt org_bau_BigInt_sub_2(i32_array* a, i32_array* b) {
    i32_array* result = org_bau_BigInt_copyOf_2(a, _arrayLen(a));
...
i8_array* org_bau_BigInt_bigInt_toStr_1(org_bau_BigInt_bigInt this) {
    ...
    org_bau_BigInt_str buff = org_bau_BigInt_str_0();
    ...
    int64_t start = 0;
    if (this.negative) {
        buff.data->data[idx_2(0, _arrayLen(buff.data))] = 45;
        start = 1;
    ...
    while (1) {
        ...
        if (( i + 9 ) >= _arrayLen(buff.data)) {
            org_bau_BigInt_str b2 = org_bau_BigInt_str_0();
            i8_array* _t3 = org_bau_BigInt_copyOfRange_i8_array_i8_3(buff.data, 0, _arrayLen(buff.data) * 2);
            _incUseStack(_t3);
            _decUse(b2.data, i8_array);
            b2.data = _t3;
            org_bau_BigInt_str_copy(&b2);
            org_bau_BigInt_str_free(&buff);
            buff = b2;
            _decUseStack(_t3, i8_array);
            org_bau_BigInt_str_free(&b2);
        }
        int64_t _t4 = org_bau_Int_intToStr_4(val, buff.data, i, 9);
        i = _t4;
        org_bau_BigInt_bigInt_copy(&next);
        org_bau_BigInt_bigInt_free(&n);
        n = next;
        int64_t _t5 = org_bau_BigInt_bigInt_signum_1(n);
        if (_t5 == 0) {
    ...
    while (1 == 1) {
        int64_t _t6 = i > ( start + 1 );
        if (_t6) {
            int64_t _t7 = buff.data->data[idx_2(i - 1, _arrayLen(buff.data))] == 48;
            _t6 = _t7;
        }
        if (!(_t6)) {
            break;
    ...
    while (i > start) {
        i = i - 1;
        int8_t temp = buff.data->data[idx_2(i, _arrayLen(buff.data))];
        buff.data->data[idx_2(i, _arrayLen(buff.data))] = buff.data->data[idx_2(start, _arrayLen(buff.data))];
        buff.data->data[idx_2(start, _arrayLen(buff.data))] = temp;
        start = start + 1;
    }
    i8_array* _t8 = org_bau_BigInt_copyOfRange_i8_array_i8_3(buff.data, 0, end);
...
int64_t org_bau_Int_compareUnsigned_2(int64_t a, int64_t b) {
    a = a + (-9223372036854775807LL-1LL);
    b = b + (-9223372036854775807LL-1LL);
    if (a == b) {
        return 0;
    }
    if (a < b) {
...
int64_t org_bau_Int_intToStr_4(int64_t n, i8_array* buff, int64_t start, int64_t size) {
    int64_t i = 0;
    while (i < size) {
        buff->data[idx_2(start + i, _arrayLen(buff))] = 48 + (imod_2(n, 10));
        n = idiv_2(n, 10);
        i = i + 1;
    }
    int64_t _r0 = i + start;
...
int64_t org_bau_Int_numberOfLeadingZeros_1(int64_t x) {
    ...
    while (shift > 0) {
        if (x >= ( shiftLeft_2(1, shift) )) {
            n = n - shift;
            x = shiftRight_int_2(x, shift);
        }
        shift = shiftRight_int_2(shift, 1);
    }
    return n;
}
int64_t shiftLeft_2(int64_t a, int64_t b) {
...
int main(int _argc, char *_argv[]) {
    ...
    __argc = _argc;
    __argv = _argv;
    string_1051 = str_const("assertion failed: ", 18);
    string_1052 = str_const("toInt(add(newBigInt(123), newBigInt(456))) == 579", 49);
    string_1054 = str_const("toInt(shiftRight(add(shiftLeft(newBigInt(123), 100), shiftLeft(newBigInt(456), 100)), 100)) == 579", 98);
    string_1056 = str_const("toInt(sub(newBigInt(1000), newBigInt(250))) == 750", 50);
    string_1058 = str_const("toInt(sub(newBigInt(250), newBigInt(1000))) == -750", 51);
    string_1060 = str_const("toInt(mul(newBigInt(20), newBigInt(5))) == 100", 46);
    string_1062 = str_const("toInt(shiftRight(mul(shiftLeft(newBigInt(20), 100), shiftLeft(newBigInt(5), 100)), 200)) == 100", 95);
    string_1064 = str_const("toInt(div(newBigInt(100), newBigInt(5))) == 20", 46);
    string_1066 = str_const("toInt(div(shiftLeft(newBigInt(100), 100), shiftLeft(newBigInt(5), 100))) == 20", 78);
    string_1068 = str_const("toInt(shiftLeft(newBigInt(1), 3)) == 8", 38);
    string_1070 = str_const("toInt(shiftRight(newBigInt(16), 2)) == 4", 40);
    string_1072 = str_const("toInt(neg(newBigInt(50))) == -50", 32);
    string_1074 = str_const("toInt(neg(neg(newBigInt(50)))) == 50", 36);
    string_1076 = str_const("compare(newBigInt(10), newBigInt(20)) == -1", 43);
    string_1078 = str_const("compare(newBigInt(10), newBigInt(-20)) == 1", 43);
    string_1080 = str_const("compare(newBigInt(10), newBigInt(10)) == 0", 42);
    string_1082 = str_const("signum(newBigInt(123)) == 1", 27);
    string_1084 = str_const("signum(newBigInt(0)) == 0", 25);
    string_1086 = str_const("signum(newBigInt(-123)) == -1", 29);
    string_1088 = str_const("len(newBigInt(1)) == 1", 22);
    string_1090 = str_const("len(newBigInt(2)) == 2", 22);
    string_1092 = str_const("len(newBigInt(255)) == 8", 24);
    string_1094 = str_const("len(newBigInt(256)) == 9", 24);
    string_1096 = str_const("len(shiftLeft(newBigInt(256), 100)) == 109", 42);
    _main();
    return 0;
}
void _main() {
    ...
    MIN_I32 = -2147483648;
    MAX_I32 = 4294967295;
    org_bau_BigInt_bigInt _t21 = org_bau_BigInt_newBigInt_1(123);
    org_bau_BigInt_bigInt _t22 = org_bau_BigInt_newBigInt_1(456);
    org_bau_BigInt_bigInt _t23 = org_bau_BigInt_bigInt_add_2(_t21, _t22);
    int64_t _t24 = org_bau_BigInt_bigInt_toInt_1(_t23);
    if (!(( _t24 == 579 ))) {
        printf("assertion failed: toInt(add(newBigInt(123), newBigInt(456))) == 579\n");
    } else {
    }
    org_bau_BigInt_bigInt _t25 = org_bau_BigInt_newBigInt_1(123);
    org_bau_BigInt_bigInt _t26 = org_bau_BigInt_bigInt_shiftLeft_2(_t25, 100);
    org_bau_BigInt_bigInt _t27 = org_bau_BigInt_newBigInt_1(456);
    org_bau_BigInt_bigInt _t28 = org_bau_BigInt_bigInt_shiftLeft_2(_t27, 100);
    org_bau_BigInt_bigInt _t29 = org_bau_BigInt_bigInt_add_2(_t26, _t28);
    org_bau_BigInt_bigInt _t30 = org_bau_BigInt_bigInt_shiftRight_2(_t29, 100);
    ...
    org_bau_BigInt_bigInt _t32 = org_bau_BigInt_newBigInt_1(1000);
    org_bau_BigInt_bigInt _t33 = org_bau_BigInt_newBigInt_1(250);
    org_bau_BigInt_bigInt _t34 = org_bau_BigInt_bigInt_sub_2(_t32, _t33);
    int64_t _t35 = org_bau_BigInt_bigInt_toInt_1(_t34);
    if (!(( _t35 == 750 ))) {
        printf("assertion failed: toInt(sub(newBigInt(1000), newBigInt(250))) == 750\n");
    } else {
    }
    org_bau_BigInt_bigInt _t36 = org_bau_BigInt_newBigInt_1(250);
    org_bau_BigInt_bigInt _t37 = org_bau_BigInt_newBigInt_1(1000);
    org_bau_BigInt_bigInt _t38 = org_bau_BigInt_bigInt_sub_2(_t36, _t37);
    int64_t _t39 = org_bau_BigInt_bigInt_toInt_1(_t38);
    if (!(( _t39 == -750 ))) {
        printf("assertion failed: toInt(sub(newBigInt(250), newBigInt(1000))) == -750\n");
    } else {
    }
    org_bau_BigInt_bigInt _t40 = org_bau_BigInt_newBigInt_1(20);
    org_bau_BigInt_bigInt _t41 = org_bau_BigInt_newBigInt_1(5);
    org_bau_BigInt_bigInt _t42 = org_bau_BigInt_bigInt_mul_2(_t40, _t41);
    int64_t _t43 = org_bau_BigInt_bigInt_toInt_1(_t42);
    if (!(( _t43 == 100 ))) {
        printf("assertion failed: toInt(mul(newBigInt(20), newBigInt(5))) == 100\n");
    } else {
    }
    org_bau_BigInt_bigInt _t44 = org_bau_BigInt_newBigInt_1(20);
    org_bau_BigInt_bigInt _t45 = org_bau_BigInt_bigInt_shiftLeft_2(_t44, 100);
    org_bau_BigInt_bigInt _t46 = org_bau_BigInt_newBigInt_1(5);
    org_bau_BigInt_bigInt _t47 = org_bau_BigInt_bigInt_shiftLeft_2(_t46, 100);
    org_bau_BigInt_bigInt _t48 = org_bau_BigInt_bigInt_mul_2(_t45, _t47);
    org_bau_BigInt_bigInt _t49 = org_bau_BigInt_bigInt_shiftRight_2(_t48, 200);
    ...
    org_bau_BigInt_bigInt _t51 = org_bau_BigInt_newBigInt_1(100);
    org_bau_BigInt_bigInt _t52 = org_bau_BigInt_newBigInt_1(5);
    org_bau_BigInt_bigInt _t53 = org_bau_BigInt_bigInt_div_2(_t51, _t52);
    int64_t _t54 = org_bau_BigInt_bigInt_toInt_1(_t53);
    if (!(( _t54 == 20 ))) {
        printf("assertion failed: toInt(div(newBigInt(100), newBigInt(5))) == 20\n");
    } else {
    }
    org_bau_BigInt_bigInt _t55 = org_bau_BigInt_newBigInt_1(100);
    org_bau_BigInt_bigInt _t56 = org_bau_BigInt_bigInt_shiftLeft_2(_t55, 100);
    org_bau_BigInt_bigInt _t57 = org_bau_BigInt_newBigInt_1(5);
    org_bau_BigInt_bigInt _t58 = org_bau_BigInt_bigInt_shiftLeft_2(_t57, 100);
    org_bau_BigInt_bigInt _t59 = org_bau_BigInt_bigInt_div_2(_t56, _t58);
    int64_t _t60 = org_bau_BigInt_bigInt_toInt_1(_t59);
    if (!(( _t60 == 20 ))) {
        printf("assertion failed: toInt(div(shiftLeft(newBigInt(100), 100), shiftLeft(newBigInt(5), 100))) == 20\n");
    } else {
    }
    org_bau_BigInt_bigInt _t61 = org_bau_BigInt_newBigInt_1(1);
    org_bau_BigInt_bigInt _t62 = org_bau_BigInt_bigInt_shiftLeft_2(_t61, 3);
    int64_t _t63 = org_bau_BigInt_bigInt_toInt_1(_t62);
    if (!(( _t63 == 8 ))) {
        printf("assertion failed: toInt(shiftLeft(newBigInt(1), 3)) == 8\n");
    } else {
    }
    org_bau_BigInt_bigInt _t64 = org_bau_BigInt_newBigInt_1(16);
    org_bau_BigInt_bigInt _t65 = org_bau_BigInt_bigInt_shiftRight_2(_t64, 2);
    int64_t _t66 = org_bau_BigInt_bigInt_toInt_1(_t65);
    if (!(( _t66 == 4 ))) {
        printf("assertion failed: toInt(shiftRight(newBigInt(16), 2)) == 4\n");
    } else {
    }
    org_bau_BigInt_bigInt _t67 = org_bau_BigInt_newBigInt_1(50);
    org_bau_BigInt_bigInt _t68 = org_bau_BigInt_bigInt_neg_1(_t67);
    int64_t _t69 = org_bau_BigInt_bigInt_toInt_1(_t68);
    if (!(( _t69 == -50 ))) {
        printf("assertion failed: toInt(neg(newBigInt(50))) == -50\n");
    } else {
    }
    org_bau_BigInt_bigInt _t70 = org_bau_BigInt_newBigInt_1(50);
    org_bau_BigInt_bigInt _t71 = org_bau_BigInt_bigInt_neg_1(_t70);
    org_bau_BigInt_bigInt _t72 = org_bau_BigInt_bigInt_neg_1(_t71);
    int64_t _t73 = org_bau_BigInt_bigInt_toInt_1(_t72);
    if (!(( _t73 == 50 ))) {
        printf("assertion failed: toInt(neg(neg(newBigInt(50)))) == 50\n");
    } else {
    }
    org_bau_BigInt_bigInt _t74 = org_bau_BigInt_newBigInt_1(10);
    org_bau_BigInt_bigInt _t75 = org_bau_BigInt_newBigInt_1(20);
    int64_t _t76 = org_bau_BigInt_bigInt_compare_2(_t74, _t75);
    if (!(( _t76 == -1 ))) {
        printf("assertion failed: compare(newBigInt(10), newBigInt(20)) == -1\n");
    } else {
    }
    org_bau_BigInt_bigInt _t77 = org_bau_BigInt_newBigInt_1(10);
    org_bau_BigInt_bigInt _t78 = org_bau_BigInt_newBigInt_1(-20);
    int64_t _t79 = org_bau_BigInt_bigInt_compare_2(_t77, _t78);
    if (!(( _t79 == 1 ))) {
        printf("assertion failed: compare(newBigInt(10), newBigInt(-20)) == 1\n");
    } else {
    }
    org_bau_BigInt_bigInt _t80 = org_bau_BigInt_newBigInt_1(10);
    org_bau_BigInt_bigInt _t81 = org_bau_BigInt_newBigInt_1(10);
    int64_t _t82 = org_bau_BigInt_bigInt_compare_2(_t80, _t81);
    if (!(( _t82 == 0 ))) {
        printf("assertion failed: compare(newBigInt(10), newBigInt(10)) == 0\n");
    } else {
    }
    org_bau_BigInt_bigInt _t83 = org_bau_BigInt_newBigInt_1(123);
    int64_t _t84 = org_bau_BigInt_bigInt_signum_1(_t83);
    if (!(( _t84 == 1 ))) {
        printf("assertion failed: signum(newBigInt(123)) == 1\n");
    } else {
    }
    org_bau_BigInt_bigInt _t85 = org_bau_BigInt_newBigInt_1(0);
    int64_t _t86 = org_bau_BigInt_bigInt_signum_1(_t85);
    if (!(( _t86 == 0 ))) {
        printf("assertion failed: signum(newBigInt(0)) == 0\n");
    } else {
    }
    org_bau_BigInt_bigInt _t87 = org_bau_BigInt_newBigInt_1(-123);
    int64_t _t88 = org_bau_BigInt_bigInt_signum_1(_t87);
    if (!(( _t88 == -1 ))) {
        printf("assertion failed: signum(newBigInt(-123)) == -1\n");
    } else {
    }
    org_bau_BigInt_bigInt _t89 = org_bau_BigInt_newBigInt_1(1);
    int64_t _t90 = org_bau_BigInt_bigInt_len_1(_t89);
    if (!(( _t90 == 1 ))) {
        printf("assertion failed: len(newBigInt(1)) == 1\n");
    } else {
    }
    org_bau_BigInt_bigInt _t91 = org_bau_BigInt_newBigInt_1(2);
    int64_t _t92 = org_bau_BigInt_bigInt_len_1(_t91);
    if (!(( _t92 == 2 ))) {
        printf("assertion failed: len(newBigInt(2)) == 2\n");
    } else {
    }
    org_bau_BigInt_bigInt _t93 = org_bau_BigInt_newBigInt_1(255);
    int64_t _t94 = org_bau_BigInt_bigInt_len_1(_t93);
    if (!(( _t94 == 8 ))) {
        printf("assertion failed: len(newBigInt(255)) == 8\n");
    } else {
    }
    org_bau_BigInt_bigInt _t95 = org_bau_BigInt_newBigInt_1(256);
    int64_t _t96 = org_bau_BigInt_bigInt_len_1(_t95);
    if (!(( _t96 == 9 ))) {
        printf("assertion failed: len(newBigInt(256)) == 9\n");
    } else {
    }
    org_bau_BigInt_bigInt _t97 = org_bau_BigInt_newBigInt_1(256);
    org_bau_BigInt_bigInt _t98 = org_bau_BigInt_bigInt_shiftLeft_2(_t97, 100);
    int64_t _t99 = org_bau_BigInt_bigInt_len_1(_t98);
    if (!(( _t99 == 109 ))) {
        printf("assertion failed: len(shiftLeft(newBigInt(256), 100)) == 109\n");
    } else {
    }
    org_bau_BigInt_bigInt _t100 = org_bau_BigInt_newBigInt_1(1234);
    org_bau_BigInt_bigInt _t101 = org_bau_BigInt_bigInt_shiftLeft_2(_t100, 100);
    org_bau_BigInt_bigInt _t102 = org_bau_BigInt_newBigInt_1(5678);
    org_bau_BigInt_bigInt _t103 = org_bau_BigInt_bigInt_shiftLeft_2(_t102, 100);
    org_bau_BigInt_bigInt _t104 = org_bau_BigInt_bigInt_mul_2(_t101, _t103);
    i8_array* _t105 = org_bau_BigInt_bigInt_toStr_1(_t104);
    printf("%.*s\n", _arrayLen(_t105), _t105->data);
    _decUseStack(_t105, i8_array);
    org_bau_BigInt_bigInt_free(&_t104);
    org_bau_BigInt_bigInt_free(&_t103);
    org_bau_BigInt_bigInt_free(&_t102);
    org_bau_BigInt_bigInt_free(&_t101);
    org_bau_BigInt_bigInt_free(&_t100);
    org_bau_BigInt_bigInt_free(&_t98);
    org_bau_BigInt_bigInt_free(&_t97);
    org_bau_BigInt_bigInt_free(&_t95);
    org_bau_BigInt_bigInt_free(&_t93);
    org_bau_BigInt_bigInt_free(&_t91);
    org_bau_BigInt_bigInt_free(&_t89);
    org_bau_BigInt_bigInt_free(&_t87);
