...
public class MiniBauAst {
    HashMap<String, Value> variables = new HashMap<>();
    HashMap<String, List<Statement>> functions = new HashMap<>();
    ...
    void parseProgram() {
        while (token != null) {
            ...
            if (match("fun")) {
                ...
                expect(")");
                expect("\n");
                List<Statement> list = parseList(0);
    ...
    static abstract class Statement {
        abstract void run(MiniBauAst memory);
    }
    ...
    static abstract class Expression {
        abstract Value get(MiniBauAst memory);
    }

    static class Literal extends Expression {
        Value value;
        Value get(MiniBauAst memory) {
            return value;
        }
        public String toString() {
