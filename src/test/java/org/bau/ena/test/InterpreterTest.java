...
import org.bau.ena.vm.reg.RegVM;
import org.bau.ena.vm.stack.StackBytecode;
...
public class InterpreterTest {
    ...
    public void testFloatAndOrAreCompileErrors() {
        ...
        String andSrc = """
            fun main()
                ...
                println(r and 1.0)
            """;
        try { new org.bau.ena.vm.reg.RegCompiler().compile(parse(andSrc)); fail("Expected compile error for real AND"); } catch (RuntimeException ex) {}
        ...
        String orSrc = """
            fun main()
                ...
                println(r or 1.0)
            """;
        try { new org.bau.ena.vm.reg.RegCompiler().compile(parse(orSrc)); fail("Expected compile error for real OR"); } catch (RuntimeException ex) {}
    }
    ...
    public void testTruthinessRequiresInt_AndOr() {
        ...
        String s1 = """
            fun main()
                println('' and 1)
            """;
        try { new org.bau.ena.vm.reg.RegCompiler().compile(parse(s1)); fail("Expected compile error: text in and"); } catch (RuntimeException ex) {}
        ...
        String s2 = """
            fun main()
                println((int[0]) or 0)
            """;
        try { new org.bau.ena.vm.reg.RegCompiler().compile(parse(s2)); fail("Expected compile error: array in or"); } catch (RuntimeException ex) {}
    }
        ...
        String s1 = """
            fun main()
                if 1.0
                    println(1)
            """;
        try { new org.bau.ena.vm.reg.RegCompiler().compile(parse(s1)); fail("Expected compile error: if with real"); } catch (RuntimeException ex) {}
        ...
        String s2 = """
            fun main()
                if 'hello'
                    println(1)
            """;
        try { new org.bau.ena.vm.reg.RegCompiler().compile(parse(s2)); fail("Expected compile error: if with text"); } catch (RuntimeException ex) {}
    }
    ...
    public void testStructEqualsNonZeroForbidden_CompileError() {
        ...
        try { new org.bau.ena.vm.stack.StackCompiler().compile(parse(src)); fail("Expected compile error for struct = 1"); } catch (RuntimeException ex) {}
        try { new org.bau.ena.vm.reg.RegCompiler().compile(parse(src)); fail("Expected compile error for struct = 1 (Reg)"); } catch (RuntimeException ex) {}
    }
    ...
    public void testExitOutsideLoopCompileError() {
        ...
        try {
            new org.bau.ena.vm.reg.RegCompiler().compile(prog);
