...
public final class EnaInterpreter {

    static final class EnaFunction {
        final String name;
        final Stmt.Function def;

        EnaFunction(String name, Stmt.Function def) {
            this.name = name;
            this.def = def;
        }
    }
    ...
    public EnaInterpreter setPrintToSystemOut(boolean print) {
        this.print = print;
        return this;
    }

    public EnaInterpreter setMaxOps(long maxOps) {
        this.maxOps = maxOps <= 0 ? Long.MAX_VALUE : maxOps;
        return this;
    }

    public EnaInterpreter setCheckEvery(int k) {
    ...
    public Object execute(Stmt.Program program) {
        ...
        // Built-in: puts
        functions.put("puts", new EnaFunction("puts", null));
        // Built-in: format
        functions.put("format", new EnaFunction("format", null));
