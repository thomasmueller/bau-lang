...
public class NumberToStringTest {
    ...
    public void doubleTest2() {
        assertEquals(Double.toString(Double.NEGATIVE_INFINITY), NumberToString.convertDoubleToString2(Double.NEGATIVE_INFINITY));
        assertEquals(Double.toString(Double.POSITIVE_INFINITY), NumberToString.convertDoubleToString2(Double.POSITIVE_INFINITY));
        assertEquals(Double.toString(0.0 / 0.0), NumberToString.convertDoubleToString2(0.0 / 0.0));
        ...
        for (double n : list) {
            ...
            String got = NumberToString.convertDoubleToString2(n);
            double n2 = Double.parseDouble(got);
            double diff = diff(n, n2);
            if (diff > 1e-15 && n2 != n) {
                fail("expected " + expected + " got " + got + " diff " + diff + " diff " + (n2 - n));
    ...
    public void longTest2() {
        ...
        String expected = Long.toString(Long.MIN_VALUE);
        String got = NumberToString.convertIntToI8Array(Long.MIN_VALUE);
        assertEquals(expected, got);
        expected = Long.toString(Long.MAX_VALUE);
        got = NumberToString.convertIntToI8Array(Long.MAX_VALUE);
        assertEquals(expected, got);
    }
